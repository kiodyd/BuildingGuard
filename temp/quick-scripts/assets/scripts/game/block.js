...
cc._RF.push(module, '395c3EwSQNPLI0SghZMqMSR', 'block', __filename);
// scripts/block.js
...
cc.Class({
    ...
    sendDirectMsg: function sendDirectMsg(direction) {
    ...
    onPreSolve: function onPreSolve(contact, selfCollider, otherCollider) {
        if (this.inputEnabled && Game.GameManager.gameState === GameState.Play) {
            ...
            //关闭辅助
            var assistBar = this.node.parent.getChildByName("key_assistBar");
    ...
    setDirect: function setDirect(dir) {
        this.direction = dir;
    }
});
