(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/lib/matchvs/matchvs.all.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '24174lbxtdGNKstkCiiA+1l', 'matchvs.all', __filename);
// scripts/matchvs/matchvs.all.js
...
var MVS = function (e) {
  var t = { version: "SDK_RELMatchvs_V3.7.9.1.2", Game: { id: 0, appkey: "" }, DEBUG: !1, IsWss: !1, IsNotice: !0, SetWss: function SetWss(e) {
      this.IsWss = e;
  ...
  var o = { NONE: 0, INITING: 1, HAVE_INIT: 2, LOGINING: 4, HAVE_LOGIN: 8, IN_ROOM: 16, CREATEROOM: 32, JOIN_ROOMING: 64, LEAVE_ROOMING: 128, LOGOUTING: 256, RECONNECTING: 512, IN_WATCHING: 1024, IN_WATCH: 2048, LEAVE_WATCHING: 4096, TEAMMATCHING: 8192, IN_TEAM: 16384 };e.ENGE_STATE = o, e.MvsState = function () {
    var t = o.NONE;this.ReSet = function () {
      ...
      var e = this.HaveLogin();return e < 0 ? e : (e = this.StateDoing()) < 0 ? e : r(o.IN_TEAM) ? -8 : r(o.IN_WATCH) ? -8 : r(o.IN_ROOM) ? -8 : 0;
  ...
  for (var r, e, o, s, i = 1, a = [].slice.call(arguments), n = 0, p = t.length, g = "", u = !1, l = !1, c = function c() {
    return a[i++];
  }, m = function m() {
    ...
    if (r = t[n], u) switch (u = !1, "." == r ? (l = !1, r = t[++n]) : "0" == r && "." == t[n + 1] ? (l = !0, r = t[n += 2]) : l = !0, s = m(), r) {case "b":
        g += parseInt(c(), 10).toString(2);break;case "c":
        "string" == typeof (e = c()) || e instanceof String ? g += e : g += String.fromCharCode(parseInt(e, 10));break;case "d":
        g += parseInt(c(), 10);break;case "f":
        o = String(parseFloat(c()).toFixed(s || 6)), g += l ? o : o.replace(/^0/, "");break;case "j":
        g += JSON.stringify(c());break;case "o":
        g += "0" + parseInt(c(), 10).toString(8);break;case "s":
        g += c();break;case "x":
        g += "0x" + parseInt(c(), 10).toString(16);break;case "X":
        g += "0x" + parseInt(c(), 10).toString(16).toUpperCase();break;default:
        g += r;} else "%" === r ? u = !0 : g += r;
  }return g;
...
});var BOM_UTF_8 = [239, 187, 191];function stringToUtf8ByteArray(e, t) {
  if (t && !0 === t) {
    if (e && e instanceof Uint8Array) {
      var r = new Uint8Array(e.length + BOM_UTF_8.length);return r.set(BOM_UTF_8, 0), r.set(e, BOM_UTF_8.length), r;
    }return console.warn("array is not instance of Uint8Array "), new Uint8Array(0);
  }if (!e || "string" != typeof e) return new Uint8Array(0);for (var o = [], s = 0, i = 0; i < e.length; i++) {
    var a = e.charCodeAt(i);a < 128 ? o[s++] = a : (a < 2048 ? o[s++] = a >> 6 | 192 : (55296 == (64512 & a) && i + 1 < e.length && 56320 == (64512 & e.charCodeAt(i + 1)) ? (a = 65536 + ((1023 & a) << 10) + (1023 & e.charCodeAt(++i)), o[s++] = a >> 18 | 240, o[s++] = a >> 12 & 63 | 128) : o[s++] = a >> 12 | 224, o[s++] = a >> 6 & 63 | 128), o[s++] = 63 & a | 128);
  }var n;n = new Uint8Array(o.length);for (var p = 0; p < o.length; p++) {
    n[p + 0] = o[p];
  }return n;
}function isStartUtf8BomArray(e) {
  if (e && e instanceof Uint8Array && 3 <= e.length) {
    for (var t = 0; t < BOM_UTF_8.length; t++) {
      if (e[t] !== BOM_UTF_8[t]) return !1;
    }return !0;
  }return !1;
}function utf8ByteArrayToString(e) {
  if (isStartUtf8BomArray(e)) return e.slice(3);for (var t = [], r = 0, o = 0; r < e.length;) {
  ...
  var t = { isNeedWSS: function isNeedWSS() {
    ...
    }, getGtwUrl: function getGtwUrl(e, t) {
      return this.getWs() + (this.isNeedWSS() ? t : e + ":7001");
    }, isEmptyObj: function isEmptyObj(e) {
      var t = !0;if ("object" != (typeof e === "undefined" ? "undefined" : _typeof(e))) return !0;for (var r in e) {
        t = !1;
      }return t;
  ...
  var o,
      ...
      s,
      i = !1,
      a = (o = ["C"], (t = function t() {}).prototype.isInvailed = function (e) {
    for (var t = function (e) {
      e.length;var t = e.split("#");return 2 !== t.length ? "" : t[1];
    }(e), r = 0; r < o.length; r++) {
      if (t === o[r]) return i = !0;
    }return console.error("[游戏账户与渠道不匹配，请使用cocos账号登录Matchvs官网创建游戏]：(https://www.matchvs.com/cocos)"), !1;
  }, t);e.AppKeyCheck = a, s = "", (r = e).CCAnalytics && (r.ccReport = new function () {
    this.init = function () {
      i && (r.CCAnalytics && r.CCAnalytics.init({ appID: "673213760", appSecret: "fdfb6e64e71457866d7785414002c628", channel: "cocos_mvs", version: "1.0.0" }), r.CCAnalytics && r.CCAnalytics.onPause(!0), r.CCAnalytics && r.CCAnalytics.onResume(!0));
  ...
  function g(t, e) {
    ...
    r.byteLength = function (e) {
      ...
      for (var t, r = m(e), o = r[0], s = r[1], i = new c((g = o, u = s, 3 * (g + u) / 4 - u)), a = 0, n = 0 < s ? o - 4 : o, p = 0; p < n; p += 4) {
    ...
    };for (var n = [], l = [], c = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = 0, i = o.length; s < i; ++s) {
    ...
    var o = e("base64-js"),
      ...
      if ("string" == typeof e) return function (e, t) {
        "string" == typeof t && "" !== t || (t = "utf8");if (!l.isEncoding(t)) throw new TypeError("Unknown encoding: " + t);var r = 0 | m(e, t),
            o = a(r),
      ...
      for (var t = e.length < 0 ? 0 : 0 | c(e.length), r = a(t), o = 0; o < t; o += 1) {
        r[o] = 255 & e[o];
      }return r;
    }function c(e) {
      ...
      }var s = this.length - t;if ((void 0 === r || s < r) && (r = s), 0 < e.length && (r < 0 || t < 0) || t > this.length) throw new RangeError("Attempt to write outside buffer bounds");o || (o = "utf8");for (var i, a, n, p, g, u, l, c, m, d = !1;;) {
        switch (o) {case "hex":
            return y(this, e, t, r);case "utf8":case "utf-8":
            return c = t, m = r, N(C(e, (l = this).length - c), l, c, m);case "ascii":
            return R(this, e, t, r);case "latin1":case "binary":
            return R(this, e, t, r);case "base64":
            return p = this, g = t, u = r, N(A(e), p, g, u);case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":
      ...
      e >>>= 0, t >>>= 0, r || _(e, t, this.length);for (var o = this[e], s = 1, i = 0; ++i < t && (s *= 256);) {
        o += this[e + i] * s;
      }return o;
    }, l.prototype.readUIntBE = function (e, t, r) {
      e >>>= 0, t >>>= 0, r || _(e, t, this.length);for (var o = this[e + --t], s = 1; 0 < t && (s *= 256);) {
        o += this[e + --t] * s;
      }return o;
      ...
      e >>>= 0, t >>>= 0, r || _(e, t, this.length);for (var o = t, s = 1, i = this[e + --o]; 0 < o && (s *= 256);) {
        i += this[e + --o] * s;
      }return (s *= 128) <= i && (i -= Math.pow(2, 8 * t)), i;
    }, l.prototype.readInt8 = function (e, t) {
      return e >>>= 0, t || _(e, 1, this.length), 128 & this[e] ? -1 * (255 - this[e] + 1) : this[e];
    }, l.prototype.readInt16LE = function (e, t) {
      e >>>= 0, t || _(e, 2, this.length);var r = this[e] | this[e + 1] << 8;return 32768 & r ? 4294901760 | r : r;
    }, l.prototype.readInt16BE = function (e, t) {
      e >>>= 0, t || _(e, 2, this.length);var r = this[e + 1] | this[e] << 8;return 32768 & r ? 4294901760 | r : r;
      ...
      (e = +e, t >>>= 0, r >>>= 0, o) || B(this, e, t, r, Math.pow(2, 8 * r) - 1, 0);var s = 1,
          i = 0;for (this[t] = 255 & e; ++i < r && (s *= 256);) {
        this[t + i] = e / s & 255;
      }return t + r;
    }, l.prototype.writeUIntBE = function (e, t, r, o) {
      (e = +e, t >>>= 0, r >>>= 0, o) || B(this, e, t, r, Math.pow(2, 8 * r) - 1, 0);var s = r - 1,
      ...
      if (e = +e, t >>>= 0, !o) {
        var s = Math.pow(2, 8 * r - 1);B(this, e, t, r, s - 1, -s);
      }var i = 0,
          a = 1,
    ...
    r.read = function (e, t, r, o, s) {
      var i,
          ...
          l = r ? s - 1 : 0,
          c = r ? -1 : 1,
          m = e[t + l];for (l += c, i = m & (1 << -u) - 1, m >>= -u, u += n; 0 < u; i = 256 * i + e[t + l], l += c, u -= 8) {}for (a = i & (1 << -u) - 1, i >>= -u, u += o; 0 < u; a = 256 * a + e[t + l], l += c, u -= 8) {}if (0 === i) i = 1 - g;else {
        if (i === p) return a ? NaN : 1 / 0 * (m ? -1 : 1);a += Math.pow(2, o), i -= g;
      ...
      var a,
          ...
          m = o ? 0 : i - 1,
          d = o ? 1 : -1,
          f = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (n = isNaN(t) ? 1 : 0, a = u) : (a = Math.floor(Math.log(t) / Math.LN2), t * (p = Math.pow(2, -a)) < 1 && (a--, p *= 2), 2 <= (t += 1 <= a + l ? c / p : c * Math.pow(2, 1 - l)) * p && (a++, p /= 2), u <= a + l ? (n = 0, a = u) : 1 <= a + l ? (n = (t * p - 1) * Math.pow(2, s), a += l) : (n = t * Math.pow(2, l - 1) * Math.pow(2, s), a = 0)); 8 <= s; e[r + m] = 255 & n, m += d, n /= 256, s -= 8) {}for (a = a << s | n, g += s; 0 < g; e[r + m] = 255 & a, m += d, a /= 256, g -= 8) {}e[r + m - d] |= 128 * f;
    };
  }, {}], 4: [function (e, t, r) {
    ...
    var s = e("google-protobuf"),
      ...
      var r = { gameid: s.Message.getFieldWithDefault(t, 1, 0), userid: s.Message.getFieldWithDefault(t, 2, 0), sdkversion: s.Message.getFieldWithDefault(t, 3, ""), gameversion: s.Message.getFieldWithDefault(t, 4, ""), echodata: t.getEchodata_asB64() };return e && (r.$jspbMessageInstance = t), r;
    }), proto.stream.SpeedReq.deserializeBinary = function (e) {
      var t = new s.BinaryReader(e),
          r = new proto.stream.SpeedReq();return proto.stream.SpeedReq.deserializeBinaryFromReader(r, t);
      ...
      for (; t.nextField() && !t.isEndGroup();) {
        switch (t.getFieldNumber()) {case 1:
            ...
            r = t.readString();e.setSdkversion(r);break;case 4:
            r = t.readString();e.setGameversion(r);break;case 5:
            r = t.readBytes();e.setEchodata(r);break;default:
            t.skipField();}
      }return e;
    }, proto.stream.SpeedReq.prototype.serializeBinary = function () {
      var e = new s.BinaryWriter();return proto.stream.SpeedReq.serializeBinaryToWriter(this, e), e.getResultBuffer();
    }, proto.stream.SpeedReq.serializeBinaryToWriter = function (e, t) {
      var r = void 0;0 !== (r = e.getGameid()) && t.writeUint32(1, r), 0 !== (r = e.getUserid()) && t.writeUint32(2, r), 0 < (r = e.getSdkversion()).length && t.writeString(3, r), 0 < (r = e.getGameversion()).length && t.writeString(4, r), 0 < (r = e.getEchodata_asU8()).length && t.writeBytes(5, r);
      ...
      var r = { status: s.Message.getFieldWithDefault(t, 1, 0), echodata: t.getEchodata_asB64() };return e && (r.$jspbMessageInstance = t), r;
    }), proto.stream.SpeedRsp.deserializeBinary = function (e) {
      var t = new s.BinaryReader(e),
          r = new proto.stream.SpeedRsp();return proto.stream.SpeedRsp.deserializeBinaryFromReader(r, t);
      ...
      var e = new s.BinaryWriter();return proto.stream.SpeedRsp.serializeBinaryToWriter(this, e), e.getResultBuffer();
    }, proto.stream.SpeedRsp.serializeBinaryToWriter = function (e, t) {
      var r = void 0;0 !== (r = e.getStatus()) && t.writeEnum(1, r), 0 < (r = e.getEchodata_asU8()).length && t.writeBytes(2, r);
      ...
      var $jscomp = { scope: {}, getGlobal: function getGlobal(e) {
        ...
        for (var r = 0, o = goog.string.trim(String(e)).split("."), s = goog.string.trim(String(t)).split("."), i = Math.max(o.length, s.length), a = 0; 0 == r && a < i; a++) {
          var n = o[a] || "",
              ...
              u = RegExp("(\\d*)(\\D*)", "g");do {
            var l = g.exec(n) || ["", "", ""],
                c = u.exec(p) || ["", "", ""];if (0 == l[0].length && 0 == c[0].length) break;r = 0 == l[1].length ? 0 : parseInt(l[1], 10);var m = 0 == c[1].length ? 0 : parseInt(c[1], 10);r = goog.string.compareElements_(r, m) || goog.string.compareElements_(0 == l[2].length, 0 == c[2].length) || goog.string.compareElements_(l[2], c[2]);
          } while (0 == r);
        }return r;
        ...
        return e instanceof Function ? e.displayName || e.name || "unknown type name" : e instanceof Object ? e.constructor.displayName || e.constructor.name || Object.prototype.toString.call(e) : null === e ? "null" : typeof e === "undefined" ? "undefined" : _typeof(e);
          ...
          Fia,
          Gia;jspb.Map.prototype.loadFromArray_ = function () {
...
}function Packet() {}function MatchvsHeader() {
  ...
  function t(e) {
    this.mCallback = e;var r = function r(e, t, _r, o) {
      var s = _r ? "application/json" : "application/x-www-form-urlencoded",
          i = new XMLHttpRequest();i.open(_r ? "POST" : "GET", e, !0), i.setRequestHeader("Content-type", s), i.onreadystatechange = function () {
        4 === i.readyState && (200 === i.status ? t.onMsg(i.responseText) : t.onErr(i.status, i.statusText));
      }, _r ? "object" == (typeof o === "undefined" ? "undefined" : _typeof(o)) ? i.send(JSON.stringify(o)) : i.send(o) : i.send(null);
    };this.get = function (e) {
    ...
    e.MatchvsNetWork = function (e, t) {
      ...
      var s = null,
        ...
        (s = new egret.WebSocket()).type = egret.WebSocket.TYPE_BINARY, s.addEventListener(egret.ProgressEvent.SOCKET_DATA, l, this), s.addEventListener(egret.Event.CONNECT, g, this), s.addEventListener(egret.Event.CLOSE, u, this), s.addEventListener(egret.IOErrorEvent.IO_ERROR, c, this), s.connectByUrl(e);
      }();
      ...
      function r(o, s, e, t) {
        var r = e ? "application/json" : "application/x-www-form-urlencoded",
            i = new BK.HttpUtil(o);i.setHttpMethod(e ? "post" : "get"), i.setHttpHeader("Content-type", r), i.requestAsync(function (e, t) {
          if (200 === t) {
  ...
  var c = proto.stream,
      m = { GTW_SPEED_REQ: 1001, GTW_SPEED_RSP: 1002, LOGIN_REQ: 1101, LOGIN_RSP: 1102, GTW_HEART_BEAT_REQ: 1103, GTW_HEART_BEAT_RSP: 1103, LOGOUT_REQ: 1105, LOGOUT_RSP: 1106, DISCONNECT_REQ: 1107, DISCONNECT_RSP: 1108, NETWORK_STATE_NOTIFY: 1122, CREATE_ROOM_REQ: 1203, CREATE_ROOM_RSP: 1204, JOIN_ROOM_REQ: 1201, JOIN_ROOM_RSP: 1202, JOIN_ROOM_NOTIFY: 1301, CHECK_IN_REQ: 1401, CHECK_IN_RSP: 1402, CHECK_IN_NOTIFY: 1410, JOIN_OVER_REQ: 1213, JOIN_OVER_RSP: 1214, JOIN_OVER_NOTIFY: 1306, SET_ROOM_PROPERTY_REQ: 1219, SET_ROOM_PROPERTY_RSP: 1220, SET_ROOM_PROPERTY_NOTIFY: 1307, JOIN_OPEN_REQ: 1221, JOIN_OPEN_RSP: 1222, JOIN_OPEN_NOTIFY: 1308, HOTEL_HEART_BEAT_REQ: 1403, HOTEL_HEART_BEAT_RSP: 1404, BROADCAST_REQ: 1405, BROADCAST_RSP: 1406, BROADCAST_NOTIFY: 1408, KICK_PLAYER_REQ: 1303, KICK_PLAYER_RSP: 1304, KICK_PLAYER_NOTIFY: 1305, LEAVE_ROOM_REQ: 1205, LEAVE_ROOM_RSP: 1206, LEAVE_ROOM_NOTIFY: 1302, GET_ROOMLIST_REQ: 1207, GET_ROOMLIST_RSP: 1208, GET_ROOM_DETAIL_REQ: 1209, GET_ROOM_DETAIL_RSP: 1210, SET_FRAMESYNC_REQ: 1419, SET_FRAMESYNC_RSP: 1420, SET_FRAMESYNC_NOTIFY: 1422, SEND_FRAME_DATA_REQ: 1423, SEND_FRAME_DATA_RSP: 1424, FRAME_DATA_NOTIFY: 1426, FRAME_SYNC_NOTIFY: 1428, SUBSCRIBE_REQ: 1411, SUBSCRIBE_RSP: 1412, SUBSCRIBE_DATA_REQ: 1413, SUBSCRIBE_DATA_RSP: 1414, SUBSCRIBE_DATA_NOTIFY: 1416, GET_ROOMLIST_EX_REQ: 1215, GET_ROOMLIST_EX_RSP: 1216, SET_RECONNECT_TIMEOUT_REQ: 1109, SET_RECONNECT_TIMEOUT_RSP: 1110, JOIN_WATCHROOM_REQ: 1225, JOIN_WATCHROOM_RSP: 1226, LEAVE_WATCHROOM_REQ: 1227, LEAVE_WATCHROOM_RSP: 1228, GET_WATCHROOM_REQ: 1229, GET_WATCHROOM_RSP: 1230, CHANGE_ROLE_REQ: 1231, CHANGE_ROLE_RSP: 1232, ENTER_LIVEROOM_REQ: 3401, ENTER_LIVEROOM_RSP: 3402, ENTER_LIVEROOM_NOTIFY: 3420, LIVE_HEARTBEAT_REQ: 3403, LIVE_HEARTBEAT_RSP: 3404, LIVE_BROADCAST_REQ: 3405, LIVE_BROADCAST_RSP: 3406, LIVE_BROADCAST_NOTIFY: 3424, SET_LIVEOFFSET_REQ: 3407, SET_LIVEOFFSET_RSP: 3408, EXIT_LIVEROOM_NOTIFY: 3422, LIVE_OVER_NOTIFY: 3426, LIVE_FRAMEDATA_NOTIFY: 3428, LIVE_FRAMESYNC_NOTIFY: 3430, CREATE_TEAM_REQ: 1233, CREATE_TEAM_RSP: 1234, JOIN_TEAM_REQ: 1235, JOIN_TEAM_RSP: 1236, JOIN_TEAM_NOTIFY: 1309, LEAVE_TEAM_REQ: 1237, LEAVE_TEAM_RSP: 1238, LEAVE_TEAM_NOTIFY: 1310, TEAM_MATCH_REQ: 1239, TEAM_MATCH_RSP: 1240, TEAM_MATCH_RESULT_NOTIFY: 1311, TEAM_MATCH_START_NOTIFY: 1312, GET_CACHEDATA_REQ: 1429, GET_CACHEDATA_RSP: 1430, CANCEL_TEAMMATCH_REQ: 1241, CANCEL_TEAMMATCH_RSP: 1242, CANCEL_TEAMMATCH_NOTIFY: 1313, SEND_TEAMEVENT_REQ: 1243, SEND_TEAMEVENT_RSP: 1244, SEND_TEAMEVENT_NOTIFY: 1314, KICK_TEAMMEMBER_REQ: 1245, KICK_TEAMMEMBER_RSP: 1246, KICK_TEAMMEMBER_NOTIFY: 1315 };e.PtoCmd = m;var n = new function e() {
    return e.prototype;
  }();n[m.GTW_SPEED_RSP] = c.SpeedRsp, n[m.LOGIN_RSP] = c.LoginRsp, n[m.JOIN_ROOM_RSP] = c.JoinRoomRsp, n[m.CHECK_IN_RSP] = c.CheckInAck, n[m.CREATE_ROOM_RSP] = c.CreateRoomRsp, n[m.CHECK_IN_NOTIFY] = c.CheckInNotify, n[m.JOIN_OVER_RSP] = c.JoinOverRsp, n[m.LEAVE_ROOM_RSP] = c.LeaveRoomRsp, n[m.JOIN_ROOM_NOTIFY] = c.NoticeJoin, n[m.HOTEL_HEART_BEAT_RSP] = c.HeartbeatAck, n[m.LEAVE_ROOM_NOTIFY] = c.NoticeLeave, n[m.BROADCAST_RSP] = c.BroadcastAck, n[m.BROADCAST_NOTIFY] = c.Notify, n[m.SUBSCRIBE_RSP] = c.SubscribeAck, n[m.SUBSCRIBE_DATA_RSP] = c.PublishAck, n[m.SUBSCRIBE_DATA_NOTIFY] = c.PublishNotify, n[m.GTW_HEART_BEAT_RSP] = c.HeartbeatRsp, n[m.GET_ROOMLIST_RSP] = c.GetRoomListRsp, n[m.LOGOUT_RSP] = c.LogoutRsp, n[m.DISCONNECT_RSP] = c.DisconnectRsp, n[m.KICK_PLAYER_NOTIFY] = c.KickPlayerNotify, n[m.KICK_PLAYER_RSP] = c.KickPlayerRsp, n[m.SET_FRAMESYNC_RSP] = c.SetFrameSyncRateAck, n[m.SEND_FRAME_DATA_RSP] = c.FrameBroadcastAck, n[m.SET_FRAMESYNC_NOTIFY] = c.SetFrameSyncRateNotify, n[m.FRAME_DATA_NOTIFY] = c.FrameDataNotify, n[m.NETWORK_STATE_NOTIFY] = c.NetworkStateNotify, n[m.FRAME_SYNC_NOTIFY] = c.FrameSyncNotify, n[m.GET_ROOMLIST_EX_RSP] = c.GetRoomListExRsp, n[m.JOIN_OVER_NOTIFY] = c.JoinOverNotify, n[m.GET_ROOM_DETAIL_RSP] = c.GetRoomDetailRsp, n[m.SET_ROOM_PROPERTY_RSP] = c.SetRoomPropertyRsp, n[m.SET_ROOM_PROPERTY_NOTIFY] = c.NoticeRoomProperty, n[m.JOIN_OPEN_RSP] = c.JoinOpenRsp, n[m.JOIN_OPEN_NOTIFY] = c.JoinOpenNotify, n[m.JOIN_WATCHROOM_RSP] = c.JoinWatchRoomRsp, n[m.ENTER_LIVEROOM_RSP] = c.EnterLiveRoomAck, n[m.ENTER_LIVEROOM_NOTIFY] = c.EnterLiveRoomNotify, n[m.LIVE_HEARTBEAT_RSP] = c.LiveHeartbeatAck, n[m.LIVE_BROADCAST_RSP] = c.LiveBroadcastAck, n[m.LIVE_BROADCAST_NOTIFY] = c.LiveBroadcastNotify, n[m.SET_LIVEOFFSET_RSP] = c.SetLiveOffsetAck, n[m.EXIT_LIVEROOM_NOTIFY] = c.ExitLiveRoomNotify, n[m.LIVE_OVER_NOTIFY] = c.LiveOverNotify, n[m.LIVE_FRAMEDATA_NOTIFY] = c.LiveFrameDataNotify, n[m.LIVE_FRAMESYNC_NOTIFY] = c.LiveFrameSyncNotify, n[m.LEAVE_WATCHROOM_RSP] = c.LeaveWatchRoomRsp, n[m.GET_WATCHROOM_RSP] = c.GetWatchRoomsRsp, n[m.CHANGE_ROLE_RSP] = c.ChangeRoleRsp, n[m.SET_RECONNECT_TIMEOUT_RSP] = c.SetReconnectTimeoutRsp, n[m.CREATE_TEAM_RSP] = c.CreateTeamRsp, n[m.JOIN_TEAM_RSP] = c.JoinTeamRsp, n[m.JOIN_TEAM_NOTIFY] = c.JoinTeamNotify, n[m.LEAVE_TEAM_RSP] = c.LeaveTeamRsp, n[m.LEAVE_TEAM_NOTIFY] = c.LeaveTeamNotify, n[m.TEAM_MATCH_RSP] = c.TeamMatchRsp, n[m.TEAM_MATCH_RESULT_NOTIFY] = c.TeamMatchResultNotify, n[m.TEAM_MATCH_START_NOTIFY] = c.TeamMatchStartNotify, n[m.GET_CACHEDATA_RSP] = c.GetCacheDataAck, n[m.CANCEL_TEAMMATCH_RSP] = c.CancelTeamMatchRsp, n[m.CANCEL_TEAMMATCH_NOTIFY] = c.CancelTeamMatchNotify, n[m.KICK_TEAMMEMBER_RSP] = c.KickTeamMemberRsp, n[m.KICK_TEAMMEMBER_NOTIFY] = c.KickTeamMemberNotify, n[m.SEND_TEAMEVENT_RSP] = c.SendTeamEventRsp, n[m.SEND_TEAMEVENT_NOTIFY] = c.SendTeamEventNotify, e.MatchvsProtocol = function () {
    this.seq = 1;var u = 0,
        l = !1;this.fillHeader = function (e, t) {
      MVS.mtaReport && MVS.mtaReport.Report(t);var r = new ArrayBuffer(16 + e.length),
          o = new DataView(r);o.setInt32(0, r.byteLength, !0), o.setInt32(4, this.seq++, !0), o.setInt16(8, t, !0), l ? (l = !1, o.setInt16(10, 3, !0)) : o.setInt16(10, 2, !0), o.setInt32(12, Number(u), !0);for (var s = e.length, i = 0; i < s; i++) {
        o.setUint8(i + 16, e[i]);
      }return o;
      ...
      for (var t = e, r = this.parseHeader(e), o = new Uint8Array(r.size - 16), s = 0; s < o.length; s++) {
        o[s] = e.getUint8(16 + s);
      }var i = n[r.cmd],
          a = new Packet();return a.header = r, a.buf = t, i ? a.payload = i.deserializeBinary && i.deserializeBinary(e.buffer.slice(16, e.buffer.byteLength)) : MatchvsLog.logI("[WARN]unknown msg,Head:" + r), a;
    }, this.init = function () {}, this.speed = function (e) {
      var t = new c.SpeedReq();t.setGameid(e.gameID), t.setEchodata(stringToUtf8ByteArray(e.echoData)), t.setGameversion(String(e.gameVersion)), t.setUserid(123456), t.setSdkversion(String(2));var r = t.serializeBinary();return this.fillHeader(r, m.GTW_SPEED_REQ);
    }, this.login = function (e, t, r, o, s) {
      var i = hex_md5(t),
          a = format("%s&UserID=%s&GameID=%s&VersionSdk=%d&%s", o, e, r, 3, i);u = e;var n = hex_md5(a);MatchvsLog.logI("[Sign]" + a + "->" + n);var p = new c.LoginReq();p.setGameid(Number(r)), p.setAppkey(o), p.setToken(i), p.setSdkver("3"), p.setDeviceid(s), p.setSign(n);var g = p.serializeBinary();return MatchvsLog.logI("[REQ]login...userID:" + e), l = !0, this.fillHeader(g, m.LOGIN_REQ);
    }, this.roomCreate = function (e, t, r, o) {
      var s = new c.CreateRoomReq();s.setGameid(Number(e));var i = new c.PlayerInfo();i.setUserid(r.userID), i.setUserprofile(stringToUtf8ByteArray(r.userProfile)), s.setPlayerinfo(i);var a = new c.RoomInfo();if (a.setMaxplayer(Number(t.maxPlayer)), a.setCanwatch(t.canWatch), a.setMode(t.mode), a.setVisibility(t.visibility), a.setRoomname(t.roomName), a.setRoomproperty(stringToUtf8ByteArray(t.roomProperty)), s.setRoominfo(a), o) {
        var n = new c.WatchSetting();n.setCachetime(o.cacheMS), n.setMaxwatch(o.maxWatch), n.setWatchdelayms(o.delayMS), n.setWatchpersistent(o.persistent), s.setWatchsetting(n);
      }var p = s.serializeBinary();return this.fillHeader(p, m.CREATE_ROOM_REQ);
    }, this.joinRandomRoom = function (e) {
      var t = new c.JoinRoomReq();t.setGameid(Number(e.gameID)), t.setJointype(c.JoinRoomType.JOINRANDOMROOM), t.setCpproto(stringToUtf8ByteArray(e.userProfile));var r = new c.PlayerInfo();r.setUserid(e.userID), r.setUserprofile(stringToUtf8ByteArray(e.userProfile)), t.setPlayerinfo(r);var o = new c.RoomInfo();o.setMaxplayer(e.maxPlayer), o.setCanwatch(e.canWatch), o.setMode(e.mode), o.setVisibility(0), t.setRoominfo(o);var s = t.serializeBinary();return this.fillHeader(s, m.JOIN_ROOM_REQ);
    }, this.joinRoomSpecial = function (e) {
      var t = new c.JoinRoomReq();t.setGameid(Number(e.gameID)), t.setJointype(e.joinType), t.setCpproto(stringToUtf8ByteArray(e.userProfile));var r = new c.PlayerInfo();r.setUserid(e.userID), r.setUserprofile(stringToUtf8ByteArray(e.userProfile)), t.setPlayerinfo(r);var o = new c.RoomInfo();o.setMaxplayer(e.maxPlayer), o.setCanwatch(e.canWatch), o.setMode(e.mode), o.setVisibility(0), o.setRoomid(e.roomID), t.setRoominfo(o);var s = t.serializeBinary();return this.fillHeader(s, m.JOIN_ROOM_REQ);
    }, this.joinRoomWithProperties = function (e, t) {
      var r = new c.JoinRoomReq(),
          o = [],
          s = e.tags,
          i = 0;for (var a in s) {
        var n = new c.keyValue();n.setKey(a), n.setValue(s[a]), o[i++] = n;
      }r.setTagsList(o), r.setGameid(e.gameID), r.setJointype(c.JoinRoomType.JOINROOMWITHPROPERTY), r.setCpproto(stringToUtf8ByteArray(e.userProfile));var p = new c.PlayerInfo();p.setUserid(e.userID), p.setUserprofile(stringToUtf8ByteArray(e.userProfile)), r.setPlayerinfo(p);var g = new c.RoomInfo();if (g.setMaxplayer(e.maxPlayer), g.setCanwatch(e.canWatch), g.setMode(e.mode), g.setVisibility(e.visibility), g.setRoomproperty(stringToUtf8ByteArray(e.roomProperty)), g.setRoomid(e.roomID), r.setRoominfo(g), t) {
        var u = new c.WatchSetting();u.setCachetime(t.cacheMS), u.setMaxwatch(t.maxWatch), u.setWatchdelayms(t.delayMS), u.setWatchpersistent(t.persistent), r.setWatchsetting(u);
      }var l = r.serializeBinary();return this.fillHeader(l, m.JOIN_ROOM_REQ);
    }, this.roomCheckIn = function (e, t, r, o) {
      var s = new c.CheckIn();s.setGameid(Number(o)), s.setRoomid(t.getRoomid()), s.setUserid(Number(r)), s.setBookid(e.getBookid()), s.setKey(e.getBookkey());var i = s.serializeBinary();return this.fillHeader(i, m.CHECK_IN_REQ);
    }, this.getRoomList = function (e, t) {
      var r = new c.GetRoomListReq(),
          o = new c.RoomFilter();o.setCanwatch(t.canWatch), o.setMaxplayer(t.maxPlayer), o.setMode(Number(t.mode)), o.setRoomproperty(stringToUtf8ByteArray(t.roomProperty)), r.setGameid(e), r.setRoomfilter(o);var s = r.serializeBinary();return this.fillHeader(s, m.GET_ROOMLIST_REQ);
    }, this.getRoomListEx = function (e, t) {
      var r = new c.GetRoomListExReq(),
          o = new c.RoomFilter();o.setMaxplayer(t.maxPlayer), o.setMode(Number(t.mode)), o.setFull(t.full), o.setCanwatch(t.canWatch), o.setRoomproperty(stringToUtf8ByteArray(t.roomProperty)), o.setState(t.state), r.setGameid(e), r.setRoomfilter(o), r.setSort(t.sort), r.setOrder(t.order), r.setPageno(t.pageNo), r.setPagesize(t.pageSize);var s = r.serializeBinary();return this.fillHeader(s, m.GET_ROOMLIST_EX_REQ);
    }, this.getRoomDetail = function (e, t) {
      var r = new c.GetRoomDetailReq();r.setGameid(e), r.setRoomid(t);var o = r.serializeBinary();return this.fillHeader(o, m.GET_ROOM_DETAIL_REQ);
    }, this.joinOver = function (e, t, r, o) {
      var s = new c.JoinOverReq();s.setGameid(e), s.setRoomid(t), s.setCpproto(r), s.setUserid(o);var i = s.serializeBinary();return this.fillHeader(i, m.JOIN_OVER_REQ);
    }, this.leaveRoom = function (e, t, r, o) {
      var s = new c.LeaveRoomReq();s.setGameid(e), s.setUserid(t), s.setRoomid(r), s.setCpproto(stringToUtf8ByteArray(o));var i = s.serializeBinary();return this.fillHeader(i, m.LEAVE_ROOM_REQ);
    }, this.heartBeat = function (e, t) {
      var r = new c.HeartbeatReq();r.setGameid(e), r.setRoomid(t);var o = r.serializeBinary();return this.fillHeader(o, m.GTW_HEART_BEAT_REQ);
    }, this.logout = function (e) {
      var t = stringToUtf8ByteArray(e);return this.fillHeader(t, m.LOGOUT_REQ);
    }, this.broadCast = function (e, t, r, o, s) {
      var i = new c.Broadcast();i.setRoomid(e), i.setDstuidsList(t), i.setCpproto(s);var a = 32 + ((3 & r) << 2) + (3 & o);i.setFlag(a);var n = i.serializeBinary();return this.fillHeader(n, m.BROADCAST_REQ);
    }, this.subscribeEventGroup = function (e, t, r, o) {
      var s = new c.Subscribe();s.setRoomid(t), s.setGameid(e), s.setCancelsList(o), s.setConfirmsList(r);var i = s.serializeBinary();return this.fillHeader(i, m.SUBSCRIBE_REQ);
    }, this.sendEventGroup = function (e, t, r, o, s) {
      var i = new c.Publish();i.setRoomid(t), i.setPriority(r), i.setCpproto(stringToUtf8ByteArray(s)), i.setGroupsList(o);var a = i.serializeBinary();return this.fillHeader(a, m.SUBSCRIBE_DATA_REQ);
    }, this.hotelHeartBeat = function (e, t, r) {
      var o = new c.Heartbeat();o.setGameid(e), o.setRoomid(t), o.setUserid(r);var s = o.serializeBinary();return this.fillHeader(s, m.HOTEL_HEART_BEAT_REQ);
    }, this.disConnect = function (e, t, r) {
      var o = new c.DisconnectReq();o.setGameid(t), o.setRoomid(r), o.setUserid(e);var s = o.serializeBinary();return this.fillHeader(s, m.DISCONNECT_REQ);
    }, this.kickPlayer = function (e, t, r, o) {
      var s = new c.KickPlayerReq();s.setRoomid(r), s.setSrcuserid(t), s.setUserid(e), s.setCpproto(stringToUtf8ByteArray(o));var i = s.serializeBinary();return this.fillHeader(i, m.KICK_PLAYER_REQ);
    }, this.setFrameSync = function (e) {
      var t = new c.SetFrameSyncRate();MVS.DEBUG && console.log("SetFrameSyncRate :" + JSON.stringify(e)), t.setGameid(e.gameID), t.setRoomid(e.roomID), t.setPriority(e.priority), t.setFramerate(e.frameRate), t.setFrameidx(e.frameidx), t.setEnablegs(e.enableGS), t.setCacheframems(e.cacheMs);var r = t.serializeBinary();return this.fillHeader(r, m.SET_FRAMESYNC_REQ);
    }, this.sendFrameEvent = function (e, t, r, o, s) {
      var i = new c.FrameBroadcast();i.setRoomid(e), i.setPriority(t), i.setOperation(o), i.setCpproto(stringToUtf8ByteArray(r, s));var a = i.serializeBinary();return this.fillHeader(a, m.SEND_FRAME_DATA_REQ);
    }, this.setRoomProperty = function (e, t, r, o) {
      var s = new c.SetRoomPropertyReq();s.setGameid(e), s.setRoomid(r), s.setUserid(t), s.setRoomproperty(stringToUtf8ByteArray(o));var i = s.serializeBinary();return this.fillHeader(i, m.SET_ROOM_PROPERTY_REQ);
    }, this.joinOpen = function (e, t, r, o) {
      var s = new c.JoinOpenReq();s.setRoomid(r), s.setGameid(e), s.setUserid(t), s.setCpproto(stringToUtf8ByteArray(o));var i = s.serializeBinary();return this.fillHeader(i, m.JOIN_OPEN_REQ);
    }, this.joinWatchRoom = function (e, t, r, o) {
      var s = new c.JoinWatchRoomReq();s.setGameid(e), s.setRoomid(r), s.setUserid(t), s.setUserprofile(stringToUtf8ByteArray(o));var i = s.serializeBinary();return this.fillHeader(i, c.CmdId.JOINWATCHROOMREQ);
    }, this.enterLiveRoom = function (e, t, r, o, s) {
      var i = new c.EnterLiveRoom();i.setBookid(e.getBookid()), i.setTicket(e.getBookkey()), i.setGameid(t), i.setUserid(r), i.setSetid(s), i.setUserprofile(""), i.setRoomid(o);var a = i.serializeBinary();return this.fillHeader(a, c.SDKWatchCmdID.ENTERLIVEROOMCMDID);
    }, this.leaveWatchRoom = function (e, t, r, o) {
      var s = new c.LeaveWatchRoomReq();s.setCpproto(stringToUtf8ByteArray(o)), s.setGameid(e), s.setUserid(t), s.setRoomid(r);var i = s.serializeBinary();return this.fillHeader(i, c.CmdId.LEAVEWATCHROOMREQ);
    }, this.getWatchRooms = function (e, t) {
      var r = new c.GetWatchRoomsReq(),
          o = new c.RoomFilter();o.setMaxplayer(t.maxPlayer), o.setMode(Number(t.mode)), o.setFull(t.full), o.setCanwatch(t.canWatch), o.setRoomproperty(stringToUtf8ByteArray(t.roomProperty)), o.setState(t.state), r.setGameid(e), r.setRoomfilter(o), r.setSort(t.sort), r.setOrder(t.order), r.setPageno(t.pageNo), r.setPagesize(t.pageSize);var s = r.serializeBinary();return this.fillHeader(s, c.CmdId.GETWATCHROOMSREQ);
    }, this.liveHeartBeat = function (e, t, r) {
      var o = new c.LiveHeartbeat();o.setGameid(Number(e)), o.setRoomid(t), o.setUserid(Number(r));var s = o.serializeBinary();return this.fillHeader(s, c.SDKWatchCmdID.LIVEHEARTBEATCMDID);
    }, this.broadCastWatch = function (e, t, r, o, s) {
      var i = new c.LiveBroadcast();i.setRoomid(e), i.setDstuidsList(t), i.setCpproto(stringToUtf8ByteArray(s));var a = 32 + ((3 & r) << 2) + (3 & o);i.setFlag(a);var n = i.serializeBinary();return this.fillHeader(n, c.SDKWatchCmdID.LIVEBROADCASTCMDID);
    }, this.setLiveOffset = function (e, t, r, o) {
      var s = new c.SetLiveOffset();s.setGameid(e), s.setRoomid(t), s.setUserid(r), s.setOffsetms(o);var i = s.serializeBinary();return this.fillHeader(i, MVS.PtoCmd.SET_LIVEOFFSET_REQ);
    }, this.changeRoleProto = function (e, t, r, o, s) {
      var i = new c.ChangeRoleReq();i.setGameid(t), i.setRoomid(r), i.setUserid(e), i.setUserprofile(stringToUtf8ByteArray(s));var a = 0 === o ? c.RoomType.GAMEROOM : c.RoomType.WATCHROOMTYPE;i.setTargetroomtype(a);var n = i.serializeBinary();return this.fillHeader(n, MVS.PtoCmd.CHANGE_ROLE_REQ);
    }, this.setReconnectTimeout = function (e, t) {
      var r = new c.SetReconnectTimeoutReq();r.setTimeout(Number(t)), r.setUserid(Number(e));var o = r.serializeBinary();return this.fillHeader(o, MVS.PtoCmd.SET_RECONNECT_TIMEOUT_REQ);
    }, this.CreateTeam = function (e, t, r) {
      MVS.DEBUG && console.log("CreateTeam gameID:", e, " teamInfo:", t);var o = new c.TeamInfo();o.setCapacity(t.capacity), o.setTeamid(t.teamID), o.setPassword(t.password), o.setMode(t.mode), o.setOwner(t.owner), o.setVisibility(t.visibility);var s = new c.PlayerInfo();s.setUserid(r.userID), s.setUserprofile(stringToUtf8ByteArray(r.userProfile));var i = new c.CreateTeamReq();i.setGameid(Number(e)), i.setPlayerinfo(s), i.setTeaminfo(o);var a = i.serializeBinary();return this.fillHeader(a, MVS.PtoCmd.CREATE_TEAM_REQ);
    }, this.JoinTeam = function (e) {
      var t = new c.PlayerInfo();t.setUserid(e.player.userID), t.setUserprofile(stringToUtf8ByteArray(e.player.userProfile));var r = new c.JoinTeamReq();r.setGameid(e.gameID), r.setTeamid(e.teamID), r.setPlayerinfo(t), r.setPassword(e.password);var o = r.serializeBinary();return this.fillHeader(o, MVS.PtoCmd.JOIN_TEAM_REQ);
    }, this.LeaveTeam = function (e) {
      MVS.DEBUG && console.log("LeaveTeam args:", e);var t = new c.LeaveTeamReq();t.setGameid(Number(e.gameID)), t.setTeamid(e.teamID), t.setUserid(Number(e.userID));var r = t.serializeBinary();return this.fillHeader(r, MVS.PtoCmd.LEAVE_TEAM_REQ);
    }, this.TeamMatch = function (e) {
      MVS.DEBUG && console.log("TeamMatch args:", e);var t = new c.TeamMatchCond();t.setFull(e.cond.full), t.setTeammembernum(e.cond.teamMemberNum), t.setTeamnum(e.cond.teamNum), t.setTimeout(e.cond.timeout), t.setWeight(e.cond.weight), t.setWeightrange(e.cond.weightRange), t.setWeightrule(e.cond.weightRule);var r = new c.WatchSetting();r.setWatchpersistent(e.watchSet.persistent), r.setWatchdelayms(e.watchSet.delayMS), r.setMaxwatch(e.watchSet.maxWatch), r.setCachetime(e.watchSet.cacheMS);var o = new c.RoomInfo();o.setRoomproperty(stringToUtf8ByteArray(e.roomInfo.roomProperty)), o.setCanwatch(e.roomInfo.canWatch), o.setMaxplayer(e.roomInfo.maxPlayer), o.setMode(e.roomInfo.mode), o.setOwner(0), o.setRoomid(""), o.setRoomname(e.roomInfo.roomName), o.setVisibility(e.roomInfo.visibility);var s = new c.TeamMatchReq();s.setGameid(e.gameID), s.setTeamid(e.teamID), s.setUserid(e.userID), s.setCond(t), s.setRoominfo(o), s.setWatchsetting(r);var i = s.serializeBinary();return this.fillHeader(i, m.TEAM_MATCH_REQ);
    }, this.GetOffLineData = function (e) {
      var t = new c.GetCacheData();t.setCacheframems(e.cacheFrameMS), t.setRoomid(e.roomID), t.setGameid(e.gameID);var r = t.serializeBinary();return this.fillHeader(r, m.GET_CACHEDATA_REQ);
    }, this.CancelTeamMatch = function (e) {
      var t = new c.CancelTeamMatchReq();t.setGameid(e.gameID), t.setTeamid(e.teamID), t.setCpproto(stringToUtf8ByteArray(e.cpProto)), t.setUserid(e.userID);var r = t.serializeBinary();return this.fillHeader(r, m.CANCEL_TEAMMATCH_REQ);
    }, this.SendTeamEvent = function (e) {
      var t = new c.SendTeamEventReq();t.setCpproto(stringToUtf8ByteArray(e.cpProto)), t.setUserid(e.userID), t.setGameid(e.gameID), t.setDsttype(e.dstType), t.setMsgtype(e.msgType), t.setTeamid(e.teamID), t.setDstuidsList(e.dstUids);var r = t.serializeBinary();return this.fillHeader(r, m.SEND_TEAMEVENT_REQ);
    }, this.KickTeamMember = function (e) {
      var t = new c.KickTeamMemberReq();t.setDstuserid(e.dstuserID), t.setGameid(e.gameID), t.setTeamid(e.teamID), t.setUserid(e.userID), t.setCpproto(stringToUtf8ByteArray(e.cpProto));var r = t.serializeBinary();return this.fillHeader(r, m.KICK_TEAMMEMBER_REQ);
    };
  };
  ...
  e.EngineNetworkMap = function () {
    this[MVS.PtoCmd.GTW_SPEED_RSP] = new t(), this[MVS.PtoCmd.LOGIN_RSP] = new r(), this[MVS.PtoCmd.JOIN_ROOM_RSP] = new o(), this[MVS.PtoCmd.JOIN_ROOM_NOTIFY] = new s(), this[MVS.PtoCmd.CHECK_IN_RSP] = new a(), this[MVS.PtoCmd.CREATE_ROOM_RSP] = new i(), this[MVS.PtoCmd.CHECK_IN_NOTIFY] = new n(), this[MVS.PtoCmd.JOIN_OVER_RSP] = new g(), this[MVS.PtoCmd.JOIN_OVER_NOTIFY] = new l(), this[MVS.PtoCmd.LEAVE_ROOM_RSP] = new p(), this[MVS.PtoCmd.LEAVE_ROOM_NOTIFY] = new c(), this[MVS.PtoCmd.GTW_HEART_BEAT_RSP] = new M(), this[MVS.PtoCmd.HOTEL_HEART_BEAT_RSP] = new m(), this[MVS.PtoCmd.BROADCAST_RSP] = new d(), this[MVS.PtoCmd.BROADCAST_NOTIFY] = new f(), this[MVS.PtoCmd.SUBSCRIBE_RSP] = new h(), this[MVS.PtoCmd.SUBSCRIBE_DATA_RSP] = new y(), this[MVS.PtoCmd.SUBSCRIBE_DATA_NOTIFY] = new R(), this[MVS.PtoCmd.GET_ROOMLIST_RSP] = new S(), this[MVS.PtoCmd.LOGOUT_RSP] = new b(), this[MVS.PtoCmd.DISCONNECT_RSP] = new E(), this[MVS.PtoCmd.KICK_PLAYER_NOTIFY] = new v(), this[MVS.PtoCmd.KICK_PLAYER_RSP] = new T(), this[MVS.PtoCmd.SET_FRAMESYNC_RSP] = new I(), this[MVS.PtoCmd.SEND_FRAME_DATA_RSP] = new B(), this[MVS.PtoCmd.SET_FRAMESYNC_NOTIFY] = new _(), this[MVS.PtoCmd.FRAME_DATA_NOTIFY] = new F(), this[MVS.PtoCmd.FRAME_SYNC_NOTIFY] = new D(), this[MVS.PtoCmd.NETWORK_STATE_NOTIFY] = new O(), this[MVS.PtoCmd.GET_ROOMLIST_EX_RSP] = new w(), this[MVS.PtoCmd.GET_ROOM_DETAIL_RSP] = new W(), this[MVS.PtoCmd.SET_ROOM_PROPERTY_RSP] = new C(), this[MVS.PtoCmd.SET_ROOM_PROPERTY_NOTIFY] = new A(), this[MVS.PtoCmd.JOIN_OPEN_RSP] = new N(), this[MVS.PtoCmd.JOIN_OPEN_NOTIFY] = new k(), this[MVS.PtoCmd.JOIN_WATCHROOM_RSP] = new P(), this[MVS.PtoCmd.LEAVE_WATCHROOM_RSP] = new U(), this[MVS.PtoCmd.GET_WATCHROOM_RSP] = new L(), this[MVS.PtoCmd.CHANGE_ROLE_RSP] = new Y(), this[MVS.PtoCmd.ENTER_LIVEROOM_RSP] = new j(), this[MVS.PtoCmd.ENTER_LIVEROOM_NOTIFY] = new G(), this[MVS.PtoCmd.LIVE_HEARTBEAT_RSP] = new z(), this[MVS.PtoCmd.LIVE_BROADCAST_RSP] = new x(), this[MVS.PtoCmd.LIVE_BROADCAST_NOTIFY] = new V(), this[MVS.PtoCmd.SET_LIVEOFFSET_RSP] = new H(), this[MVS.PtoCmd.EXIT_LIVEROOM_NOTIFY] = new q(), this[MVS.PtoCmd.LIVE_OVER_NOTIFY] = new J(), this[MVS.PtoCmd.LIVE_FRAMEDATA_NOTIFY] = new $(), this[MVS.PtoCmd.LIVE_FRAMESYNC_NOTIFY] = new K(), this[MVS.PtoCmd.SET_RECONNECT_TIMEOUT_RSP] = new Q(), this[MVS.PtoCmd.CREATE_TEAM_RSP] = new X(), this[MVS.PtoCmd.JOIN_TEAM_RSP] = new Z(), this[MVS.PtoCmd.JOIN_TEAM_NOTIFY] = new ee(), this[MVS.PtoCmd.LEAVE_TEAM_RSP] = new te(), this[MVS.PtoCmd.LEAVE_TEAM_NOTIFY] = new re(), this[MVS.PtoCmd.TEAM_MATCH_RSP] = new oe(), this[MVS.PtoCmd.TEAM_MATCH_RESULT_NOTIFY] = new se(), this[MVS.PtoCmd.TEAM_MATCH_START_NOTIFY] = new ie(), this[MVS.PtoCmd.GET_CACHEDATA_RSP] = new ae(), this[MVS.PtoCmd.CANCEL_TEAMMATCH_RSP] = new ne(), this[MVS.PtoCmd.CANCEL_TEAMMATCH_NOTIFY] = new pe(), this[MVS.PtoCmd.KICK_TEAMMEMBER_RSP] = new le(), this[MVS.PtoCmd.KICK_TEAMMEMBER_NOTIFY] = new ce(), this[MVS.PtoCmd.SEND_TEAMEVENT_RSP] = new ge(), this[MVS.PtoCmd.SEND_TEAMEVENT_NOTIFY] = new ue();
    ...
    this.doSubHandle = function (e, t) {
      var r = e.payload.getStatus();t.speedCallBack(r, utf8ByteArrayToString(e.payload.getEchodata()));
    };
  }function r() {
    this.doSubHandle = function (e, t) {
  ...
  var l,
      p = { ID: 0, token: "" },
      c = { gameID: 0, appkey: "", channel: "", platform: "", deviceID: "", gVersion: "", threshold: 0 },
      s = [],
      i = function i(e) {
    ...
    (l = this).mState = new MVS.MvsState(), this.mAllPlayers = [], this.mRecntRoomID = 0, this.mWatchRoomID = 0, this.mTeamID = "", this.mNetWorkCallBackImp = null, this.mUserListForJoinRoomRsp = [], this.joinRoomNotifyInfo = {}, this.teamNotifyInfo = null, this.mCntRoomType = MVS.TgRoomType.NRoom, this.mGTWNetwork = null, this.mHotelNetWork = null, this.mWatchNetwrok = null, this.mProtocol = new u.MatchvsProtocol(), this.isSpeed = {}, this.nodeDelayInfo = {};var g = {},
        r = function (o) {
      var s = u.MsUtil.getWs() + o.gateway + ":" + u.Host.HOST_GATWAY_PORT;s in l.isSpeed || (l.isSpeed[s] = !0);var e = new NetWorkCallBackImp(l),
          i = new MVS.MatchvsNetWork(s, e);g[o.sid] = i;var a = new u.MvsTicker(),
          n = 0,
          p = a.setInterval(function () {
        var e = { sid: o.sid, url: s, tm: Date.now() },
            t = { gameID: c.gameID, echoData: JSON.stringify(e), gameVersion: c.gVersion },
            r = l.mProtocol.speed(t);i.send(r), n++, s in l.isSpeed && !(5 < n) || (a.clearInterval(p), console.log("clearInterval:" + s));
      }, 100);return 0;
    }.bind(this);this.speedCallBack = function (e, t) {
      var r,
          o,
          s = JSON.parse(t),
          i = Date.now() - s.tm;if (s.sid in this.nodeDelayInfo) {
        var a = this.nodeDelayInfo[s.sid];"delays" in a || (a.delays = []), a.delays.push(i), a.avgDelay = (r = a.delays, o = 0, r.forEach(function (e) {
          o += e;
      ...
      !function (r) {
        s = [];var o = u.Host.MAIN_URL + u.APIPATH.NODELIST + "platform=" + c.platform + "&channel=" + c.channel + "&gameid=" + c.gameID + "&userid=123456&virtulIP=",
            e = (c.platform, c.channel, c.gameID, { onMsg: function onMsg(e) {
            var t = JSON.parse(e);MatchvsLog.logI("[getSetList][" + o + " ]" + e), t.status && t.data && 200 === t.status ? (s.push(t.data.sets), r(t.data.sets, null)) : r(null, { errCode: -1, errMsg: "getSetList data error" });
          }, onErr: function onErr(e, t) {
            MatchvsLog.logE("getSetList failed errcode:" + e + " errmsg:" + t), r(null, { errCode: e, errMsg: t });
      ...
      if (!e) return o({ status: 0 }, null), 0;if (u.MsUtil.isEmptyObj(l.nodeDelayInfo)) return o({ status: -1 }, null), -1;var t = u.Host.MAIN_URL + u.APIPATH.SCHEDULE,
          r = { channel: c.channel, platform: c.platform, gameID: Number(c.gameID), userID: 123456 },
          s = [],
          i = l.nodeDelayInfo;for (var a in i) {
        i[a].delays.sort(), s.push({ setId: i[a].sid, gateWay: i[a].gateway, avgLatency: i[a].avgDelay, speedTimes: 5, minLatency: i[a].delays[0], maxLatency: i[a].delays[i[a].delays.length - 1], succRate: 1 });
      }var n = { params: r, speeds: s, lastSet: 100, threshold: 0, selectSet: 0 },
          p = { onMsg: function onMsg(e) {
          var t = JSON.parse(e);if (200 === t.status) {
            var r = t.data.best_sets[0];t.data.sets.forEach(function (e) {
              r === e.sid && (u.Host.HOST_GATWAY_ADDR = u.MsUtil.getGtwUrl(e.gateway, e.wssProxy));
            });
          }o(t, null);
        }, onErr: function onErr(e, t) {
      ...
      if ("{}" === JSON.stringify(this.nodeDelayInfo)) return null;var e = [];for (var t in this.nodeDelayInfo) {
        var r = this.nodeDelayInfo[t].avgDelay,
            o = this.nodeDelayInfo[t].name + "-" + this.nodeDelayInfo[t].area;e.push({ nodeID: this.nodeDelayInfo[t].sid, latency: r, area: o });
      }return e.sort(function (e, t) {
        return e.latency - t.latency;
      }), e;
    };var a = function (e) {
      if (u.MsUtil.isEmptyObj(this.nodeDelayInfo)) return -29;if (0 !== e.nodeID) {
        var t = this.nodeDelayInfo[e.nodeID];if (void 0 === t) return -29;u.Host.HOST_GATWAY_ADDR = u.MsUtil.getGtwUrl(t.gateway, t.wssProxy);
      }null !== this.mGTWNetwork && this.mGTWNetwork.close();var r = i(function (e, t) {
        null == t ? n(p.ID, p.token, p.deviceID) : MatchvsLog.logE("node schedule error:" + JSON.stringify(t));
      }.bind(this), !1);return 0 !== r ? r : 0;
    }.bind(this);this.changeNode = function (e) {
      var t = this.mState.changeNode();return 0 !== t ? t : a(e);
    }, this.init = function (e, t, r, o, s, i, a) {
      return MVS.Game.id = o, MVS.mtaReport && MVS.mtaReport.Report("init"), this.mRsp = e, c.channel = t, c.platform = r, c.gVersion = i, c.appkey = s, c.gameID = o, this.mState.SetIniting(), this.mProtocol.init(), void 0 === a ? this.getHostList() : (c.threshold = a, this.speed()), 0;
    }, this.premiseInit = function (e, t, r, o) {
      return void 0 === t || "" === t ? -1 : (this.mRsp = e, MVS.Game.id = r, c.gameID = r, c.appkey = o, 0 <= t.indexOf("wss://") || 0 <= t.indexOf("ws://") ? MVS.Host.HOST_GATWAY_ADDR = t : MVS.Host.HOST_GATWAY_ADDR = u.MsUtil.getWs() + t, this.mState.SetInit(), this.mRsp.initResponse(200), 0);
    }, this.reconnect = function () {
      var e = this.mState.ReconnectCheck();if (0 !== e) return e;if ("0" !== this.mRecntRoomID && 0 === this.mState.HaveLogin()) {
        this.mState.SetReconnecting();var t = new MsRoomJoin(MsEnum.JoinRoomType.reconnect, p.ID, this.mRecntRoomID, c.gameID, 0, 0, 0, "reconnect", [{ name: "MatchVS" }]),
            r = this.mProtocol.joinRoomSpecial(t);return this.mGTWNetwork.send(r), this.mRecntRoomID = "0", 0;
      }return 0 === c.gameID || "" === c.appkey ? -1 : (void 0 !== this.mGTWNetwork && null !== this.mGTWNetwork && this.mGTWNetwork.close(), this.mState.SetReconnecting(), this.login(p.ID, p.token, c.deviceID));
    };var n = function (e, t, r) {
      p.ID = e, this.mUserID = e, p.token = t, c.deviceID = r, MVS.ccReport && MVS.ccReport.init(), MVS.ccReport && MVS.ccReport.login(c.gameID), void 0 !== this.mGTWNetwork && null !== this.mGTWNetwork && this.mGTWNetwork.close(), this.mNetWorkCallBackImp = new NetWorkCallBackImp(this), this.mGTWNetwork = new MVS.MatchvsNetWork(MVS.Host.HOST_GATWAY_ADDR, this.mNetWorkCallBackImp);var o = this.mProtocol.login(p.ID, p.token, c.gameID, c.appkey, c.deviceID);this.mState.SetLogining(), this.mGTWNetwork.send(o), MatchvsLog.logI("login,userID" + p.ID + ", token:" + p.token);
    }.bind(this);this.login = function (r, o, s, e) {
      p.ID = r, this.mUserID = r, p.token = o, c.deviceID = s;var t = this.mState.LoginCheck();return 0 !== t ? t : new MVS.AppKeyCheck().isInvailed(c.appkey) ? e ? a({ nodeID: e }) : 0 !== (t = i(function (e, t) {
      ...
      var o = this.mState.InRoomCheck();if (o < 0) return o;if (512 < t.length) return -21;if (e.maxPlayer > MVS.Config.MAXPLAYER_LIMIT || e.maxPlayer < MVS.Config.MINPLAYER_LIMIT) return -20;var s = { roomID: 0, roomName: e.roomName, maxPlayer: e.maxPlayer, mode: e.mode, canWatch: e.canWatch, visibility: e.visibility, roomProperty: e.roomProperty, owner: 0 },
          i = { userID: p.ID, userProfile: t },
          a = this.mProtocol.roomCreate(c.gameID, s, i, r);return 1024 < a.byteLength || 512 < t.length ? -21 : (this.mState.SetCreateRoom(), this.mGTWNetwork.send(a), MatchvsLog.logI("create room"), 0);
    }, this.uninit = function () {
      return this.mState.ReSet(), this.mRsp = null, MatchvsLog.logI("unInit "), 0;
    }, this.getRoomList = function (e) {
      var t = this.mState.InRoomCheck();if (0 !== t) return t;var r = this.mProtocol.getRoomList(c.gameID, e);return 1024 < r.byteLength ? -21 : (this.mGTWNetwork.send(r), 0);
    }, this.roomCheckIn = function (e, t) {
      this.mNetWorkCallBackImp.frameCache = [], this.mHotelNetWork = new MVS.MatchvsNetWork(MVS.Host.HOST_HOTEL_ADDR, this.mNetWorkCallBackImp);var r = this.mProtocol.roomCheckIn(e, t, p.ID, c.gameID);return this.mHotelNetWork.send(r), 0;
    }, this.joinRandomRoom = function (e, t) {
      var r = this.mState.InRoomCheck();if (r < 0) return r;if (e > MVS.Config.MAXPLAYER_LIMIT || e < MVS.Config.MINPLAYER_LIMIT) return -20;if (512 < t.length) return -21;var o = new MsRoomJoin(MsEnum.JoinRoomType.joinRandomRoom, p.ID, 0, c.gameID, e, 0, 0, t, [{ name: "matchvs" }]),
      ...
      var r = this.mState.InRoomCheck();if (r < 0) return r;if (!/^[0-9]+$/.test(e)) return -1;var o = String(e).trim();if (0 === o || "" === o) return -1;var s = new MsRoomJoin(MsEnum.JoinRoomType.joinSpecialRoom, p.ID, e, c.gameID, 0, 0, 0, t, [{ name: "MatchVS" }]),
      ...
      var t = this.mState.HaveInRoom();if (t < 0) return t;if (1024 < e.length) return -21;var r = this.mProtocol.joinOver(c.gameID, this.mRoomInfo.getRoomid(), stringToUtf8ByteArray(e), p.ID);return this.mGTWNetwork.send(r), 0;
    }, this.leaveRoom = function (e) {
      var t = this.mState.LeaveRoomCheck();if (0 !== t) return t;var r = this.mRecntRoomID;if (this.mRoomInfo && this.mRoomInfo.getRoomid && (r = this.mRoomInfo.getRoomid()), 1024 < e.length) return -21;var o = this.mProtocol.leaveRoom(c.gameID, p.ID, r, e);return this.mGTWNetwork.send(o), this.mState.SetLeaveRooming(), this.mHotelNetWork && this.mHotelNetWork.close(), MatchvsLog.logI("leaveRoom"), 0;
    }, this.kickPlayer = function (e, t) {
      var r = this.mState.HaveInRoom();if (r < 0) return r;if (1024 < t.length) return -21;var o = this.mProtocol.kickPlayer(e, p.ID, this.mRoomInfo.getRoomid(), t);return this.mGTWNetwork.send(o), 0;
    }, this.setFrameSync = function (e, t, r) {
      void 0 === r && (r = { cacheFrameMS: 0 });var o = this.mState.HaveInRoom();if (o < 0) return o;if (20 < e || e < 0) return -20;if (6e5 < r.cacheFrameMS) return -25;var s = { gameID: c.gameID, roomID: this.mRoomInfo.getRoomid(), priority: 0, frameRate: e, frameidx: 1, enableGS: t, cacheMs: r.cacheFrameMS },
          i = this.mProtocol.setFrameSync(s);return this.mHotelNetWork.send(i), 0;
    }, this.sendFrameEvent = function (e, t, r) {
      var o = this.mState.HaveInRoom();if (o < 0) return o;if (1024 < e.length) return -21;var s = this.mProtocol.sendFrameEvent(this.mRoomInfo.getRoomid(), 0, e, t || 2, r);return this.mHotelNetWork.send(s), 0;
    }, this.joinOpen = function (e) {
      var t = this.mState.HaveInRoom();if (t < 0) return t;var r = this.mProtocol.joinOpen(c.gameID, p.ID, this.mRoomInfo.getRoomid(), e);return this.mGTWNetwork.send(r), 0;
    };
    ...
    var e;if (void 0 !== c.gameID && "" !== c.gameID && 0 !== c.gameID && (e = void 0 === l.mRoomInfo ? 0 : l.mRoomInfo.getRoomid(), !l.mState.IsLoginOuting())) {
      var t = l.mProtocol.heartBeat(c.gameID, e);l.mGTWNetwork.send(t), MatchvsLog.logI("gateway heartBeat:");
    }
  }, e.prototype.sendEvent = function (e, t) {
    var r = this.mState.HaveInRoom();if (0 !== r) return { sequence: this.mProtocol.seq - 1, result: r };if (1024 < e.length) return -21;var o = this.mProtocol.broadCast(this.mRoomInfo.getRoomid(), [this.mUserID], 1, 0, stringToUtf8ByteArray(e, t));return this.mHotelNetWork.send(o), { sequence: this.mProtocol.seq - 1, result: 0 };
  }, e.prototype.sendEventEx = function (e, t, r, o, s) {
    var i = this.mState.HaveInRoom();if (0 !== i) return { sequence: this.mProtocol.seq - 1, result: i };if ("string" != typeof t) return { sequence: this.mProtocol.seq - 1, result: -1 };if (0 !== e && 1 !== e && 2 !== e) return { sequence: this.mProtocol.seq - 1, result: -23 };if (0 !== r && 1 !== r) return { sequence: this.mProtocol.seq - 1, result: -24 };if (1024 < t.length) return -21;var a = this.mProtocol.broadCast(this.mRoomInfo.getRoomid(), o, r, e, stringToUtf8ByteArray(t, s));return this.mHotelNetWork.send(a), { sequence: this.mProtocol.seq - 1, result: 0 };
  }, e.prototype.subscribeEventGroup = function (e, t) {
    var r = this.mState.HaveInRoom();if (0 !== r) return r;if (0 === e.length && 0 === t.length) return -20;var o = this.mProtocol.subscribeEventGroup(c.gameID, this.mRoomInfo.getRoomid(), e, t);return this.mHotelNetWork.send(o), 0;
  }, e.prototype.sendEventGroup = function (e, t) {
    var r = this.mState.HaveInRoom();if (0 !== r) return r;if (t.length <= 0) return -20;if (1024 < e.length) return -21;var o = this.mProtocol.sendEventGroup(c.gameID, this.mRoomInfo.getRoomid(), 1, t, e);return this.mHotelNetWork.send(o), 0;
  }, e.prototype.hotelHeartBeat = function () {
    if (l.mState.IsLeaveRooming()) return 0;l.mState.SetLogin(), l.mState.SetInRoom();var e = l.mProtocol.hotelHeartBeat(c.gameID, l.mRoomInfo.getRoomid(), p.ID);l.mHotelNetWork.send(e), MatchvsLog.logI("hotel heartBeat:");
  }, e.prototype.registerUser = function () {
    MVS.mtaReport && MVS.mtaReport.Report("registerUser");var e = this.mState.HaveInit();if (0 !== e) return e;var t = c.channel,
        r = "regUserInfo" + t + c.platform,
        o = c.gVersion,
      ...
      var i = JSON.parse(s);return this.mRsp.registerUserResponse(new MsRegistRsp(i.status, i.data.userid, i.data.token, i.data.nickname, i.data.avatar)), MatchvsLog.logI("load user info from cache:" + i), 0;
        ...
        var t = JSON.parse(e);MatchvsLog.logI("[registerUser][ " + n + " ]" + e), 0 === t.status ? (LocalStore_Save(r, e), this.rsp(new MsRegistRsp(t.status, t.data.userid, t.data.token, t.data.nickname, t.data.avatar))) : this.rsp(new MsRegistRsp(t.status, 0, "err", e, "err")), MVS.mtaReport && MVS.mtaReport.Report("registerUserResponse");
      }, onErr: function onErr(e, t) {
    ...
    var e = c.gameID,
        t = c.channel,
        r = c.platform,
        o = u.APIPATH.HOSTLIST,
        s = MVS.MsUtil.isNeedWSS(),
        i = MVS.Host.MAIN_URL + o + "?mac=0&gameid=" + e + "&channel=" + t + "&platform=" + r + (s ? "&useWSSProxy=1" : ""),
        a = this,
        n = { onMsg: function onMsg(e) {
        var t = JSON.parse(e);if (MatchvsLog.logI("[getHostList][ " + i + " ]" + e), 200 === t.status) {
          a.mState.SetInit();var r = "https://";MVS.Host.VS_USER_URL = r + t.data.vsuser, MVS.Host.HOST_GATWAY_ADDR = u.MsUtil.getGtwUrl(t.data.engine, t.data.wssProxy), MVS.Host.CMSNS_URL = r + t.data.cmsns, MVS.Host.VS_OPEN_URL = r + t.data.vsopen, MVS.Host.VS_PAY_URL = r + t.data.vspay, MVS.Host.VS_PRODUCT_URL = r + t.data.VS_PRODUCT_URL;
    ...
    var t = this.mState.HaveLogin();if (0 !== t) return t;var r = this.mProtocol.getRoomListEx(c.gameID, e);return this.mGTWNetwork.send(r), 0;
  }, e.prototype.getRoomDetail = function (e) {
    var t = this.mState.HaveLogin();if (0 !== t) return t;var r = this.mProtocol.getRoomDetail(c.gameID, e);return this.mGTWNetwork.send(r), 0;
  }, e.prototype.setRoomProperty = function (e, t) {
    if (0 === t.length) return -1;if (1024 < t.length) return -21;var r = this.mState.HaveInRoom();if (0 !== r) return r;var o = this.mProtocol.setRoomProperty(c.gameID, p.ID, e, t);return this.mGTWNetwork.send(o), 0;
  }, e.prototype.joinWatchRoom = function (e, t) {
    var r = this.mState.InRoomCheck();if (0 !== r) return r;if (512 < t.length) return -21;this.mWatchRoomID = e;var o = this.mProtocol.joinWatchRoom(c.gameID, p.ID, this.mWatchRoomID, t);return this.mState.SetJoinWatching(), this.mGTWNetwork.send(o), r;
  }, e.prototype.enterLiveRoom = function (e, t) {
    this.mNetWorkCallBackImp.frameCache = [], t && (this.mWatchRoomID = t), this.mWatchNetwrok = new MVS.MatchvsNetWork(MVS.Host.HOST_WATCH_ADDR, this.mNetWorkCallBackImp);var r = this.mProtocol.enterLiveRoom(e, c.gameID, p.ID, this.mWatchRoomID, 0);return this.mWatchNetwrok.send(r), 0;
  }, e.prototype.liveHeartBeat = function () {
    var e = l,
        t = e.mRecntRoomID,
        r = e.mProtocol.liveHeartBeat(c.gameID, t, p.ID);return e.mWatchNetwrok.send(r), MatchvsLog.logI("live heartBeat"), 0;
  }, e.prototype.leaveWatchRoom = function (e) {
    var t = this.mState.HaveLogin();if (0 !== t) return t;var r = this.mWatchRoomID,
        o = this.mProtocol.leaveWatchRoom(c.gameID, p.ID, r, e);return this.mGTWNetwork.send(o), MatchvsLog.logI("leaveWatchRoom"), 0;
    ...
    var t = this.mState.HaveInWatch();if (0 !== t) return t;var r = this.mWatchRoomID,
        o = this.mProtocol.setLiveOffset(c.gameID, r, p.ID, e);return this.mWatchNetwrok.send(o), 0;
  }, e.prototype.getWatchRoomList = function (e) {
    var t = this.mState.HaveLogin();if (0 !== t) return t;var r = this.mProtocol.getWatchRooms(c.gameID, e);return this.mGTWNetwork.send(r), 0;
    ...
    }if (0 !== s) return s;var i = this.mProtocol.changeRoleProto(p.ID, c.gameID, r, o, e);return this.mGTWNetwork.send(i), 0;
  }, e.prototype.setReconnectTimeout = function (e) {
    var t = Number(e),
        r = this.mState.HaveLogin();if (0 !== r) return r;if (t < -1 || 600 < t) return -27;var o = this.mProtocol.setReconnectTimeout(p.ID, e);return this.mGTWNetwork.send(o), 0;
    ...
    var t = this.mState.InRoomCheck();if (0 !== t) return t;if (512 < e.userProfile.length) return -21;if (50 < Number(e.capacity) || Number(e.capacity) < 1) return -20;var r = { teamID: "0", password: e.password, capacity: e.capacity, mode: e.mode, owner: 0, visibility: e.visibility },
        o = { userID: p.ID, userProfile: e.userProfile },
        s = this.mProtocol.CreateTeam(c.gameID, r, o);return this.mGTWNetwork.send(s), 0;
  }, e.prototype.joinTeam = function (e) {
    var t = this.mState.InRoomCheck();if (0 !== t) return t;if (512 < e.userProfile.length) return -21;this.mTeamID = e.teamID;var r = { gameID: c.gameID, teamID: e.teamID, password: e.password, player: { userID: p.ID, userProfile: e.userProfile } },
        o = this.mProtocol.JoinTeam(r);return this.mGTWNetwork.send(o), 0;
  }, e.prototype.leaveTeam = function () {
    var e = this.mState.HaveLogin();if (0 !== e) return e;var t = { gameID: c.gameID, userID: p.ID, teamID: this.mTeamID },
        r = this.mProtocol.LeaveTeam(t);return this.mGTWNetwork.send(r), 0;
  }, e.prototype.teamMatch = function (e) {
    var t = this.mState.InRoomCheck();if (0 !== t) return t;if (512 < e.roomProperty.length) return -21;if (100 < e.maxPlayer || e.maxPlayer < 0) return -20;var r = { gameID: c.gameID, teamID: this.mTeamID, userID: p.ID, cond: e.cond, watchSet: e.watchSet, roomInfo: { roomName: e.roomName, mode: e.mode, maxPlayer: e.maxPlayer, canWatch: e.canWatch, visibility: e.visibility, roomProperty: e.roomProperty } },
    ...
    var t = this.mState.HaveInRoom();if (0 !== t) return t;var r = { gameID: c.gameID, roomID: this.mRecntRoomID + "", cacheFrameMS: e },
        o = this.mProtocol.GetOffLineData(r);return this.mHotelNetWork.send(o), 0;
  }, e.prototype.cancelTeamMatch = function (e) {
    if (1024 < i(e.cpProto)) return -21;if (!this.mState.IsTeamMatching()) return -1;if ("" === this.mTeamID) return -1;var t = { gameID: c.gameID, teamID: this.mTeamID, userID: p.ID, cpProto: e.cpProto },
        r = this.mProtocol.CancelTeamMatch(t);return this.mGTWNetwork.send(r), 0;
  }, e.prototype.sendTeamEvent = function (e) {
    if (1024 < i(e.data)) return -21;var t = this.mState.HaveInTeam();if (0 !== t) return t;var r = { gameID: c.gameID, teamID: this.mTeamID, userID: p.ID, dstType: e.dstType, msgType: e.msgType, cpProto: e.data, dstUids: e.dstUserIDs },
        o = this.mProtocol.SendTeamEvent(r);return this.mGTWNetwork.send(o), 0;
  }, e.prototype.kickTeamMember = function (e) {
    if (1024 < i(e.cpProto)) return -21;var t = this.mState.HaveInTeam();if (0 !== t) return t;var r = { gameID: c.gameID, teamID: this.mTeamID, userID: p.ID, dstuserID: e.userID, cpProto: e.cpProto },
        o = this.mProtocol.KickTeamMember(r);return this.mGTWNetwork.send(o), 0;
  }, window.MatchvsEngine = e, u.MatchvsEngine = e;
}(MVS || {});try {
